...
echo "🔧 Sepolia Testnet Setup for Real Estate Crowdfunding"
echo "====================================================="
echo ""
...
if grep -q "your_private_key_here" .env; then
    ...
    echo ""
    echo "After updating .env, run: ./deploy-sepolia-fixed.js"
    exit 1
fi
...
npx hardhat run deploy-sepolia-fixed.js --network sepolia
